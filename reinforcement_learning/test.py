...
from torch.utils.tensorboard import SummaryWriter  # 导入模块
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter(log_dir='runs/simple_gridworld')  # 初始化 TensorBoard writer
    ...
    for epoch in range(num_epochs):
        ...
        writer.add_scalar("Loss/train", total_loss.item(), epoch)  # TensorBoard 记录
